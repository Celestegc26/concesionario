...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.concesionario.app.domain.Empleado.class.getName());
            createCache(cm, com.concesionario.app.domain.Empleado.class.getName() + ".ventas");
            createCache(cm, com.concesionario.app.domain.Cliente.class.getName());
            createCache(cm, com.concesionario.app.domain.Cliente.class.getName() + ".ventas");
